...
export type Lesson = Node & {
  ...
  videoPlataformType: VideoPlataforms;
};
...
export type LessonManyWhereInput = {
  ...
  videoPlataformType?: InputMaybe<VideoPlataforms>;
  /** All values that are contained in given list. */
  videoPlataformType_in?: InputMaybe<Array<InputMaybe<VideoPlataforms>>>;
  /** All values that are not equal to given value. */
  videoPlataformType_not?: InputMaybe<VideoPlataforms>;
  /** All values that are not contained in given list. */
  videoPlataformType_not_in?: InputMaybe<Array<InputMaybe<VideoPlataforms>>>;
};
...
export enum LessonOrderByInput {
  ...
  VideoPlataformTypeAsc = 'videoPlataformType_ASC',
  VideoPlataformTypeDesc = 'videoPlataformType_DESC'
}
...
/** Qual a plataforma do video */
export enum VideoPlataforms {
  Vimeo = 'Vimeo',
  Youtube = 'Youtube',
  Mp4 = 'mp4'
}
